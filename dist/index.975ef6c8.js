...
input.addEventListener("input", (0, _lodashDebounceDefault.default)(onInputChange, DEBOUNCE_DELAY));
function onInputChange() {
    searchCountryName = input.value.trim();
    if (searchCountryName === "") {
        cleaner();
        return;
    } else (0, _fetchCountries.fetchCountries)(searchCountryName).then((countryName)=>{
...
},{"lodash.debounce":"3JP5n","notiflix":"5WWYd","./css/styles.css":"1CY4s","./js/fetchCountries":"dKuy9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
...
},{}],"1CY4s":[function() {},{}],"dKuy9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
